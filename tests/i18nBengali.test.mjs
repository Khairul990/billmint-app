...
it('1.1: English ↔ Bengali dictionary parity (every key translates)', () => {
  ...
  const probeKeys = [
    ...
    ...['dl.title', 'dl.subtitle', 'dl.send_reminder_all', 'dl.export_due', 'dl.total_outstanding',
        'dl.collect_money', 'dl.remind', 'dl.ledger', 'dl.search_ph', 'dl.all_settled', 'dl.no_match'],
    ...['est.title', 'est.create', 'est.total', 'est.pending', 'est.accepted', 'est.converted',
        'est.tab_all', 'est.tab_rejected', 'est.search_ph', 'est.empty', 'est.empty_sub'],
    ...['ord.title', 'ord.create', 'ord.stat_total', 'ord.stat_completed', 'ord.registry',
        'ord.search_ph', 'ord.status_in_progress', 'ord.status_delivered', 'ord.none_yet'],
    ...['hc.title', 'hc.subtitle', 'hc.academy', 'hc.academy_sub', 'hc.search_ph'],
    ...['sup.title', 'sup.how', 'sup.email', 'sup.chat', 'sup.faq', 'sup.ticket', 'sup.desc_ph'],
