  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        body: ['"Plus Jakarta Sans"', 'Outfit', 'Inter', 'system-ui', 'sans-serif'],
        display: ['Sora', 'Outfit', 'sans-serif'],
        numbers: ['Sora', '"Space Grotesk"', 'JetBrains Mono', 'monospace'],
      ...
      colors: {
        bq: {
          emerald: '#0B8F78',
          'emerald-deep': '#075E50',
          'emerald-bright': '#18B99B',
          champagne: '#C8A96B',
          'surface-app': 'var(--bq-surface-app)',
          'surface-primary': 'var(--bq-surface-primary)',
          'surface-secondary': 'var(--bq-surface-secondary)',
          'surface-elevated': 'var(--bq-surface-elevated)',
          'surface-financial': 'var(--bq-surface-financial)',
          'border-soft': 'var(--bq-border-soft)',
          'border-strong': 'var(--bq-border-strong)',
          'text-primary': 'var(--bq-text-primary)',
          'text-secondary': 'var(--bq-text-secondary)',
          'text-muted': 'var(--bq-text-muted)',
          accent: 'var(--bq-accent)',
          'accent-strong': 'var(--bq-accent-strong)',
          'accent-muted': 'var(--bq-accent-muted)',
