  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'premium-lg': '0 20px 60px -12px rgba(7, 13, 25, 0.08), 0 8px 24px -6px rgba(7, 13, 25, 0.04)',
        'premium-xl': '0 30px 80px -20px rgba(7, 13, 25, 0.12), 0 10px 32px -8px rgba(7, 13, 25, 0.06)',
