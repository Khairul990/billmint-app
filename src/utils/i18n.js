...
const dictionary = {
  en: {
    ...
    'studio.ready': "Ready", 'studio.readiness': "Workspace Readiness",
    'studio.readiness_hint': "Complete these to unlock the full experience:",
    'studio.readiness_done': "Everything is configured — you are all set!",
    'studio.chk_name': "Business name", 'studio.chk_owner': "Owner name",
    'studio.chk_phone': "Phone number", 'studio.chk_email': "Email",
    'studio.chk_currency': "Currency", 'studio.chk_address': "Business address",
    'studio.chk_prefix': "Invoice prefix", 'studio.chk_backup': "Auto backup",
    'studio.qa_invoice': "New Invoice", 'studio.qa_remind': "Send Reminders",
    'studio.qa_theme': "Appearance", 'studio.qa_backup': "Backup Data",
  ...
  bn: {
    ...
    'studio.ready': "প্রস্তুত", 'studio.readiness': "ওয়ার্কস্পেস প্রস্তুতি",
    'studio.readiness_hint': "সম্পূর্ণ অভিজ্ঞতার জন্য এগুলো সম্পূর্ণ করো:",
    'studio.readiness_done': "সব কনফিগার করা আছে — তুমি সম্পূর্ণ প্রস্তুত!",
    'studio.chk_name': "বিজনেসের নাম", 'studio.chk_owner': "মালিকের নাম",
    'studio.chk_phone': "ফোন নম্বর", 'studio.chk_email': "ইমেইল",
    'studio.chk_currency': "কারেন্সি", 'studio.chk_address': "বিজনেসের ঠিকানা",
    'studio.chk_prefix': "ইনভয়েস প্রিফিক্স", 'studio.chk_backup': "অটো ব্যাকআপ",
    'studio.qa_invoice': "নতুন ইনভয়েস", 'studio.qa_remind': "রিমাইন্ডার পাঠাও",
    'studio.qa_theme': "থিম-অ্যাপিয়ারেন্স", 'studio.qa_backup': "ব্যাকআপ নাও",
