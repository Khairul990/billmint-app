const ALL_THEME_COLORS = {
  ...
  'obsidian-black': { L: '#0C0C0C', D: '#0C0C0C', S: '#0C0C0C', SD: '#0C0C0C', C: '#1A1A1A', CD: '#1A1A1A', T: '#F9FAFB', TD: '#F9FAFB', M: '#7A8896', MD: '#7A8896', A: '#FFFFFF', AD: '#FFFFFF', B: 'rgba(255,255,255,0.1)', BD: 'rgba(255,255,255,0.1)', BF: '#FFFFFF', BFD: '#FFFFFF', BT: '#CCCCCC', BTD: '#CCCCCC', H: '#1A1A1A', HD: '#1A1A1A', TH: '#1A1A1A', THD: '#1A1A1A', TB: '#0C0C0C', TBD: '#0C0C0C' },
  'wine-ash': { L: '#2B2329', D: '#2B2329', S: '#2B2329', SD: '#2B2329', C: '#3E333A', CD: '#3E333A', T: '#F9FAFB', TD: '#F9FAFB', M: '#B39CA8', MD: '#B39CA8', A: '#D4A3C0', AD: '#D4A3C0', B: 'rgba(224,204,215,0.2)', BD: 'rgba(224,204,215,0.2)', BF: '#D4A3C0', BFD: '#D4A3C0', BT: '#F2C7E0', BTD: '#F2C7E0', H: '#3E333A', HD: '#3E333A', TH: '#3E333A', THD: '#3E333A', TB: '#2B2329', TBD: '#2B2329' },
  'sunlit-yellow': { L: '#141100', D: '#141100', S: '#141100', SD: '#141100', C: '#2E2500', CD: '#2E2500', T: '#F9FAFB', TD: '#F9FAFB', M: '#CCBA80', MD: '#CCBA80', A: '#FFC72C', AD: '#FFC72C', B: 'rgba(255,199,44,0.3)', BD: 'rgba(255,199,44,0.3)', BF: '#FFC72C', BFD: '#FFC72C', BT: '#FFD459', BTD: '#FFD459', H: '#2E2500', HD: '#2E2500', TH: '#2E2500', THD: '#2E2500', TB: '#141100', TBD: '#141100' },
  'turquoise': { L: '#0A1C1A', D: '#0A1C1A', S: '#0A1C1A', SD: '#0A1C1A', C: '#153633', CD: '#153633', T: '#F9FAFB', TD: '#F9FAFB', M: '#7EBAA6', MD: '#7EBAA6', A: '#99E1D9', AD: '#99E1D9', B: 'rgba(153,225,217,0.3)', BD: 'rgba(153,225,217,0.3)', BF: '#99E1D9', BFD: '#99E1D9', BT: '#B9F5EE', BTD: '#B9F5EE', H: '#153633', HD: '#153633', TH: '#153633', THD: '#153633', TB: '#0A1C1A', TBD: '#0A1C1A' },
  'midnight-blue-premium': { L: '#0A1224', D: '#0A1224', S: '#0A1224', SD: '#0A1224', C: '#163169', CD: '#163169', T: '#F9FAFB', TD: '#F9FAFB', M: '#6B8CC7', MD: '#6B8CC7', A: '#4A81E8', AD: '#4A81E8', B: 'rgba(163,194,250,0.3)', BD: 'rgba(163,194,250,0.3)', BF: '#4A81E8', BFD: '#4A81E8', BT: '#6E9DF0', BTD: '#6E9DF0', H: '#163169', HD: '#163169', TH: '#163169', THD: '#163169', TB: '#0A1224', TBD: '#0A1224' },
  'jet-black': { L: '#141414', D: '#141414', S: '#141414', SD: '#141414', C: '#262626', CD: '#262626', T: '#F9FAFB', TD: '#F9FAFB', M: '#7A8896', MD: '#7A8896', A: '#E5E5E5', AD: '#E5E5E5', B: 'rgba(255,255,255,0.15)', BD: 'rgba(255,255,255,0.15)', BF: '#E5E5E5', BFD: '#E5E5E5', BT: '#FFFFFF', BTD: '#FFFFFF', H: '#262626', HD: '#262626', TH: '#262626', THD: '#262626', TB: '#141414', TBD: '#141414' },
  'orchid': { L: '#2B1D28', D: '#2B1D28', S: '#2B1D28', SD: '#2B1D28', C: '#4A3144', CD: '#4A3144', T: '#F9FAFB', TD: '#F9FAFB', M: '#BFA8BB', MD: '#BFA8BB', A: '#E5BDDF', AD: '#E5BDDF', B: 'rgba(229,189,223,0.3)', BD: 'rgba(229,189,223,0.3)', BF: '#E5BDDF', BFD: '#E5BDDF', BT: '#F7D7F3', BTD: '#F7D7F3', H: '#4A3144', HD: '#4A3144', TH: '#4A3144', THD: '#4A3144', TB: '#2B1D28', TBD: '#2B1D28' },
  'blush-onyx': { L: '#0D0D0D', D: '#0D0D0D', S: '#0D0D0D', SD: '#0D0D0D', C: '#1C1C1C', CD: '#1C1C1C', T: '#F9FAFB', TD: '#F9FAFB', M: '#A87E8F', MD: '#A87E8F', A: '#F7A6C1', AD: '#F7A6C1', B: 'rgba(247,166,193,0.3)', BD: 'rgba(247,166,193,0.3)', BF: '#F7A6C1', BFD: '#F7A6C1', BT: '#FFC2D7', BTD: '#FFC2D7', H: '#1C1C1C', HD: '#1C1C1C', TH: '#1C1C1C', THD: '#1C1C1C', TB: '#0D0D0D', TBD: '#0D0D0D' },
  'violet-slate': { L: '#2B0D1E', D: '#2B0D1E', S: '#2B0D1E', SD: '#2B0D1E', C: '#4C1935', CD: '#4C1935', T: '#F9FAFB', TD: '#F9FAFB', M: '#A0A5BB', MD: '#A0A5BB', A: '#8A8FA3', AD: '#8A8FA3', B: 'rgba(138,143,163,0.3)', BD: 'rgba(138,143,163,0.3)', BF: '#8A8FA3', BFD: '#8A8FA3', BT: '#A5AACC', BTD: '#A5AACC', H: '#4C1935', HD: '#4C1935', TH: '#4C1935', THD: '#4C1935', TB: '#2B0D1E', TBD: '#2B0D1E' }
};
...
export const THEME_INFO = {
  ...
  'obsidian-black': { name: 'Obsidian Black', category: 'Premium Dark', colors: ['#FFFFFF', '#1A1A1A', '#0C0C0C', '#7A8896'] },
  'wine-ash': { name: 'Wine Ash', category: 'Premium Dark', colors: ['#D4A3C0', '#3E333A', '#2B2329', '#B39CA8'] },
  'sunlit-yellow': { name: 'Sunlit Yellow', category: 'Premium Dark', colors: ['#FFC72C', '#2E2500', '#141100', '#CCBA80'] },
  'turquoise': { name: 'Turquoise', category: 'Premium Dark', colors: ['#99E1D9', '#153633', '#0A1C1A', '#7EBAA6'] },
  'midnight-blue-premium': { name: 'Midnight Blue (Premium)', category: 'Premium Dark', colors: ['#4A81E8', '#163169', '#0A1224', '#6B8CC7'] },
  'jet-black': { name: 'Jet Black', category: 'Premium Dark', colors: ['#E5E5E5', '#262626', '#141414', '#7A8896'] },
  'orchid': { name: 'Orchid', category: 'Premium Dark', colors: ['#E5BDDF', '#4A3144', '#2B1D28', '#BFA8BB'] },
  'blush-onyx': { name: 'Blush Onyx', category: 'Premium Dark', colors: ['#F7A6C1', '#1C1C1C', '#0D0D0D', '#A87E8F'] },
  'violet-slate': { name: 'Violet Slate', category: 'Premium Dark', colors: ['#8A8FA3', '#4C1935', '#2B0D1E', '#A0A5BB'] }
};
