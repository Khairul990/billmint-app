export const ALL_THEME_COLORS = {
  ...
  'obsidian-black': { L: '#F1F5F9', D: '#0C0C0C', S: '#FFFFFF', SD: '#0C0C0C', C: '#F8FAFC', CD: '#1A1A1A', T: '#0F172A', TD: '#F9FAFB', M: '#64748B', MD: '#7A8896', A: '#0C0C0C', AD: '#FFFFFF', B: '#E2E8F0', BD: 'rgba(255,255,255,0.05)', BF: '#1A1A1A', BFD: '#FFFFFF', BT: '#0C0C0C', BTD: '#CCCCCC', H: '#0F172A', HD: '#1A1A1A', TH: '#FFFFFF', THD: '#1A1A1A', TB: '#F1F5F9', TBD: '#0C0C0C' },
  'wine-ash': { L: '#F5F1F3', D: '#2B2329', S: '#FFFFFF', SD: '#2B2329', C: '#FCFAFB', CD: '#3E333A', T: '#2B1D28', TD: '#F9FAFB', M: '#8E7A86', MD: '#B39CA8', A: '#32292F', AD: '#D4A3C0', B: '#EAE0E5', BD: 'rgba(224,204,215,0.1)', BF: '#4A3A45', BFD: '#D4A3C0', BT: '#32292F', BTD: '#F2C7E0', H: '#2B1D28', HD: '#3E333A', TH: '#FFFFFF', THD: '#3E333A', TB: '#F5F1F3', TBD: '#2B2329' },
  'sunlit-yellow': { L: '#FFFDF0', D: '#141100', S: '#FFFFFF', SD: '#141100', C: '#FFFEFA', CD: '#2E2500', T: '#3D2D0B', TD: '#F9FAFB', M: '#A38547', MD: '#CCBA80', A: '#FFC72C', AD: '#FFC72C', B: '#FDEBB5', BD: 'rgba(255,199,44,0.15)', BF: '#FFC72C', BFD: '#FFC72C', BT: '#E6B01C', BTD: '#FFD459', H: '#3D2D0B', HD: '#2E2500', TH: '#FFFFFF', THD: '#2E2500', TB: '#FFFDF0', TBD: '#141100' },
  'turquoise': { L: '#F0FBF9', D: '#0A1C1A', S: '#FFFFFF', SD: '#0A1C1A', C: '#FAFEFD', CD: '#153633', T: '#0F3D39', TD: '#F9FAFB', M: '#5CA69F', MD: '#7EBAA6', A: '#1CA69D', AD: '#99E1D9', B: '#D1EFEA', BD: 'rgba(153,225,217,0.15)', BF: '#158F87', BFD: '#99E1D9', BT: '#1CA69D', BTD: '#B9F5EE', H: '#0F3D39', HD: '#153633', TH: '#FFFFFF', THD: '#153633', TB: '#F0FBF9', TBD: '#0A1C1A' },
  'midnight-blue-premium': { L: '#F1F5F9', D: '#0A1224', S: '#FFFFFF', SD: '#0A1224', C: '#F8FAFC', CD: '#163169', T: '#0F172A', TD: '#F9FAFB', M: '#6B8CC7', MD: '#6B8CC7', A: '#102552', AD: '#4A81E8', B: '#D5E1F5', BD: 'rgba(163,194,250,0.15)', BF: '#274D91', BFD: '#4A81E8', BT: '#102552', BTD: '#6E9DF0', H: '#0F172A', HD: '#163169', TH: '#FFFFFF', THD: '#163169', TB: '#F1F5F9', TBD: '#0A1224' },
  'jet-black': { L: '#F5F5F5', D: '#141414', S: '#FFFFFF', SD: '#141414', C: '#FAFAFA', CD: '#262626', T: '#111111', TD: '#F9FAFB', M: '#888888', MD: '#7A8896', A: '#1D1D1D', AD: '#E5E5E5', B: '#E0E0E0', BD: 'rgba(255,255,255,0.08)', BF: '#333333', BFD: '#E5E5E5', BT: '#1D1D1D', BTD: '#FFFFFF', H: '#111111', HD: '#262626', TH: '#FFFFFF', THD: '#262626', TB: '#F5F5F5', TBD: '#141414' },
  'orchid': { L: '#FDF5FA', D: '#2B1D28', S: '#FFFFFF', SD: '#2B1D28', C: '#FEFAFD', CD: '#4A3144', T: '#3D2235', TD: '#F9FAFB', M: '#A37F99', MD: '#BFA8BB', A: '#C77EB5', AD: '#E5BDDF', B: '#F5D3EE', BD: 'rgba(229,189,223,0.15)', BF: '#C77EB5', BFD: '#E5BDDF', BT: '#945F8E', BTD: '#F7D7F3', H: '#3D2235', HD: '#4A3144', TH: '#FFFFFF', THD: '#4A3144', TB: '#FDF5FA', TBD: '#2B1D28' },
  'blush-onyx': { L: '#FAFAFA', D: '#0D0D0D', S: '#FFFFFF', SD: '#0D0D0D', C: '#FDFBFB', CD: '#1C1C1C', T: '#1C1C1C', TD: '#F9FAFB', M: '#806A72', MD: '#A87E8F', A: '#0D0D0D', AD: '#F7A6C1', B: '#F9D0DF', BD: 'rgba(247,166,193,0.15)', BF: '#333333', BFD: '#F7A6C1', BT: '#0D0D0D', BTD: '#FFC2D7', H: '#1C1C1C', HD: '#1C1C1C', TH: '#FFFFFF', THD: '#1C1C1C', TB: '#FAFAFA', TBD: '#0D0D0D' },
