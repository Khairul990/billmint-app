...
export const Switch = ({ checked, onChange, disabled, ...props }) => {
  return (
    <button 
      ...
      disabled={disabled}
      className={`w-11 h-6 shrink-0 rounded-full transition-colors relative focus:outline-none focus:ring-2 focus:ring-theme-accent focus:ring-offset-2 focus:ring-offset-theme-app ${
