  ...
  return (
    <div className="min-h-screen bg-theme-main flex items-center justify-center p-4">
      ...
      >
        ...
        <h2 className="text-2xl font-black text-center text-theme-primary mb-2">Secure Student Portal</h2>
        <p className="text-center text-theme-muted mb-8 text-sm">
          Portal ID: <span className="font-mono font-bold">{studentId}</span>
        </p>
