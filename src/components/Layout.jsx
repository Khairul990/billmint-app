  ...
  return (
    <div className="h-[100dvh] bg-theme-app flex flex-col lg:flex-row w-full font-sans antialiased text-theme-primary transition-colors duration-300 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 h-full min-w-0 bg-theme-app transition-colors duration-300 relative z-10">
        ...
        <header className="sticky top-0 z-40 bg-theme-card/80 backdrop-blur-xl border-b border-theme-accent/20 px-4 sm:px-6 py-4 md:py-5 text-theme-primary shadow-sm transition-all duration-300">
