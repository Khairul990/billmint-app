      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div className="w-full md:w-64 relative">
          <input
            ...
            className="w-full px-4 py-2.5 bg-theme-card border border-theme-border-soft rounded-xl text-xs font-bold focus:outline-none focus:ring-2 focus:ring-theme-accent/50"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {filteredPacks.map(pack => {
          ...
          return (
            <div 
              key={pack.id}
              className={`bg-theme-card rounded-3xl p-6 border-2 transition-all duration-300 flex flex-col justify-between ${
                isActive 
              ...
              <div>
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex gap-2">
                    {pack.type === 'free' ? (
                      <span className="bg-theme-success/10 text-theme-success border border-theme-success/20 text-[9px] font-black uppercase tracking-widest px-2 py-1 rounded-full">FREE</span>
                    ) : (
                      <span className="bg-theme-warning/10 text-theme-warning border border-theme-warning/20 text-[9px] font-black uppercase tracking-widest px-2 py-1 rounded-full flex items-center gap-1 shadow-sm">
