    ...
    <div className="space-y-6 pb-24">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-theme-muted font-bold">Manage your professional clients and details</p>
        </div>
      ...
      >
        ...
        <p className="text-sm font-semibold text-theme-muted max-w-sm">
          The Client Management module is being finalized. Tracking agreements and client preferences will be available shortly.
        </p>
      </motion.div>
    </div>
  );
