          ...
          <div className="p-6 bg-theme-surface border border-theme-border-soft rounded-3xl backdrop-blur-md shadow-premium-sm space-y-5">
            ...
            {loading ? (
              ...
              <div className="space-y-3">
                {/* 1. Current Device */}
                {currentSession && (
                  <div className="p-4 bg-theme-tint-bg border border-theme-tint-border rounded-2xl flex items-center justify-between">
                    <div className="flex items-center gap-3.5">
                      <div className="w-10 h-10 rounded-xl bg-theme-tint-bg border border-theme-tint-border flex items-center justify-center text-theme-accent">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[9px] font-black text-theme-accent bg-theme-tint-bg px-2 py-0.5 rounded-full uppercase tracking-wider">
                            This Device
                          </span>
                        </div>
                        <p className="text-[11px] text-theme-accent font-bold flex items-center gap-1.5 mt-0.5">
                      ...
                      <div className="flex items-center gap-2">
                        {isPending && (
                          <button
                            ...
                            className="px-3 py-1.5 rounded-xl bg-theme-accent text-white hover:bg-theme-accent text-2xs font-bold transition-all shadow-sm flex items-center gap-1"
                          >
