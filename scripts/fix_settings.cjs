const fs = require('fs');
const path = 'e:/Khair_Murafiq_Empire/BillQyro/src/pages/Settings.jsx';
let content = fs.readFileSync(path, 'utf8');

const missing_code = `        canvas.width = width;
...
const target = /width = maxWidth;\r?\n\s*}\r?\n/;
content = content.replace(target, "width = maxWidth;\n        }\n" + missing_code);
