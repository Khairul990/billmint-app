...
import { vendorRouter, vendorPaymentRouter } from './modules/vendors/vendorRoutes.js';
...
export const createApp = () => {
  ...
  app.use(`${config.apiPrefix}/vendors`, vendorRouter);
  app.use(`${config.apiPrefix}/outsource-jobs`, outsourceRouter);
